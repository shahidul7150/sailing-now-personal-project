    ...
    <div class="hero min-h-screen bg-base-100">
      <div class="hero-content flex-col lg:flex-row-reverse">
        <img
         ...
         alt=''/>
        <div>
          <h1 class="sm:text-4xl  lg:text-5xl font-bold">JUST SAILING <span className='text-[#0C6B7F]'>WITH ENJOY</span></h1>
          <h1 class="sm:text-sm lg:text-3xl font-light">FEEL YOUR SURVIVE</h1>
          <p class="sm:text-sm  py-6 font-medium">
